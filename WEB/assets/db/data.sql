...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2018 a las 00:58:19
...
INSERT INTO `usuario` (`id_usuario`, `cod_tipo_doc`, `documento`, `nombre`, `apellido`, `cod_genero`, `email`, `password`, `cod_area`, `cod_cargo`, `cod_rol`, `cod_estado_usuario`, `fecha_creado`) VALUES
(1, 1, '123456789', 'Super', 'Admin', 1, 'sa@email.com', '123456789', 3, 1, 1, 2, '2018-05-15 15:06:13'),
(2, 1, '12345678', 'Tech', 'Admin', 2, 'tech@email.com', '12345678', 3, 1, 2, 2, '2018-05-25 17:49:59'),
(3, 1, '1234567', 'Camilo', 'Torres', 1, 'rct@email.com', '1234567', 2, 2, 3, 2, '2018-05-15 17:02:44'),
(4, 1, '123456', 'Andrés', 'García', 1, 'uag@email.com', '123456', 1, 4, 4, 2, '2018-05-17 17:51:55'),
(5, 2, '1234561', 'Dayanne', 'Adguelo', 2, 'uda@email.com', '123456', 3, 2, 2, 2, '2018-05-22 14:50:54'),
(6, 3, '1234562', 'Camila', 'Torres', 2, 'uct@email.com', '123456', 4, 3, 4, 2, '2018-05-25 17:54:32');
...
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID Usuario', AUTO_INCREMENT=7;
