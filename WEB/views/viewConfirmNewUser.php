        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="section-title modal-title text-center">Confirmar nuevo usuario</h1>
                </div>
                <hr>
                <div class="modal-body">
            <?php
                echo'
                <form method="post" action="../controllers/controllerConfirmNewUser.php" class="">

                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="hidden" name="id_usuario" id="id_usuario" class="form-control" value="'.$id_usuario.'">
                                <input type="hidden" name="temp_password_db" id="temp_password_db" class="form-control" value="'.$temp_password.'">
            ...
            ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <input id="password" type="password" name="temp_password_input" placeholder="Temporal contraseña por enviado a su correo" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                            <button id="enviar" name="btnClickedUser" value="sendCreated" type="submit" class="btn btn-block btn-success pmd-z-depth-3 pmd-ripple-effect" onsubmit="return checkPass()">Confirmar</button>
                        </div>
                        &nbsp;
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
