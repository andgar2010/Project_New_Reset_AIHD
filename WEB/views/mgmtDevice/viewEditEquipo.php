			 ...
			 <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group text-center">
                                ...
                                <?php printBtnRadioCodEstadoEquipo($cod_estado_equipo); ?>
					 ...
					 <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="hidden" name="id_equipo" id="id_equipo" class="form-control" value="<?php echo $id_equipo ?>">
                                <!-- <input type="hidden" id="serial_equipo" name="serial_equipo" value="<?php //$serial_equipo ?>" class="form-control"> -->
                                <label for="text_serial_equipo" class="control-label">Serial equipo</label>
                                <input id="text_serial_equipo" type="text" name="serial_equipo" value="<?php echo $serial_equipo ?>" class="form-control" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <?php printBtnRadioCodTipoEquipo($cod_tipo_equipo); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                            <button id="enviar" name="btnClickedUser" value="sendUpdate" type="submit" class="btn btn-block btn-success pmd-z-depth-3 pmd-ripple-effect"><i class="fa fa-refresh" aria-hidden="true"></i> Actualizar datos</i></button>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2"></div>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                            <a  onClick="goToListDevices()">
