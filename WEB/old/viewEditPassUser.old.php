        ...
        echo'
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <label for="text_documento" class="control-label">Número de cédula <em>(Inalterable)</em></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="cod_tipo_doc" class="control-label">Tipo de cédula <em>(Inalterable)</em></label>
                                <div>
                                ';
                ...
                -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="email" class="control-label">Email <em>(Inalterable)</em></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="cod_genero" class="control-label">Género de usuario <em>(Inalterable)</em></label>
                                    <div>';
                    ...
                    <div class="row">                        
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="cod_genero" class="control-label">Contraseña</label>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input id="confirm_password" type="password" name="password-repeat" placeholder="Contraseña (repetir)" class="form-control" required onkeyup="checkPass(); return false;" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group text-center">
                                <label for="cod_area" class="control-label ">Área de la Institución a la que pertenece el usuario <em>(Inalterable)</em></label>
                                <div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group text-center">
                                <label for="cod_cargo" class="control-label">&nbsp;<br>Cargo del usuario <em>(Inalterable)</em></label>
                                <div>
