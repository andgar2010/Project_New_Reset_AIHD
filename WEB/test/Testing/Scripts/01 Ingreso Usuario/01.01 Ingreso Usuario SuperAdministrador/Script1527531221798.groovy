...
WebUI.verifyElementText(findTestObject('01 Ingreso Usuarios/01.01 Ingreso Usuario SuperAdministrador/Page_New Reset AIHD Admin Dashboard/div_Super Admin'), 
    'Super Admin')

WebUI.verifyElementText(findTestObject('01 Ingreso Usuarios/01.01 Ingreso Usuario SuperAdministrador/Page_New Reset AIHD Admin Dashboard/i_Superadministrador'), 
    'Superadministrador')
