...
WebUI.click(findTestObject('01 Ingreso Usuarios/01.03 Ingreso Usuario Administrativo/Page_Bienvenido NEW RESET A.I.H.D/button_Inicia sesion'))
...
WebUI.verifyElementText(findTestObject('01 Ingreso Usuarios/01.03 Ingreso Usuario Administrativo/Page_New Reset AIHD Admin Dashboard/i_Administrativo'), 
    'Administrativo')
